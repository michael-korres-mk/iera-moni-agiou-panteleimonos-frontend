...
const resetCustomizer = async () => {
  vuetifyTheme.themes.value.light.colors.primary = '#000'
  vuetifyTheme.themes.value.dark.colors.primary = '#000'
  ...
  useStorage(namespaceConfig('initial-loader-color'), null).value = '#000'
